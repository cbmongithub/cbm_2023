	...
	return (
		<>
			...
			<section>
				...
				<Heading title="Experience" paragraph="Past and present roles" />
				...
				<Heading title="Stack" paragraph="Preferred languages and frameworks" />
				<div className="relative z-30 mx-auto mb-40 mt-20 flex max-w-screen-xl flex-row flex-wrap items-center justify-center px-4 py-8 lg:px-6">
					...
					<ToolTip text="MySQL" align="left-1">
						<motion.div
					...
					<ToolTip text="TypeScript" align="-left-2">
						<motion.div
							className="m-3 rounded-full bg-blue-600 p-2 shadow-xl"
							initial={{ y: 100, opacity: 0 }}
							whileInView={{ y: 0, opacity: 1 }}
					...
					<ToolTip text="React" align="left-2">
						<motion.div
					...
					<ToolTip text="Bootstrap" align="-right-1">
						<motion.div
					...
					<ToolTip text="NodeJS" align="-right-0">
						<motion.div
					...
					<ToolTip text="TailwindCSS" align="-right-3">
						<motion.div
					...
					<ToolTip text="NextJS" align="right-1">
						<motion.div
							className="m-3 rounded-full bg-zinc-600 p-2 shadow-xl"
							initial={{ y: 100, opacity: 0 }}
							whileInView={{ y: 0, opacity: 1 }}
					...
					<ToolTip text="MongoDB" align="-right-2">
						<motion.div
				...
				<Heading title="Tools" paragraph="Some of the daily tools I use" />
				<div className="relative z-30 mx-auto mb-40 mt-20 flex max-w-screen-xl flex-row flex-wrap items-center justify-center px-4 py-8 lg:px-6">
					<ToolTip text="VSCode" align="right-1">
						<motion.div
					...
					<ToolTip text="Git/GitHub" align="-left-2">
						<motion.div
					...
					<ToolTip text="Compass" align="-left-0">
						<motion.div
							className="m-3 rounded-full bg-green-600 p-2 shadow-xl"
							initial={{ y: 100, opacity: 0 }}
							whileInView={{ y: 0, opacity: 1 }}
					...
					<ToolTip text="Insomnia" align="-left-0">
						<motion.div
					...
					<ToolTip text="Photoshop" align="-left-2">
						<motion.div
							className="m-3 rounded-full bg-sky-400 p-2 shadow-xl"
							initial={{ y: 100, opacity: 0 }}
							whileInView={{ y: 0, opacity: 1 }}
					...
					<ToolTip text="Zoom" align="left-2">
						<motion.div
					...
					<ToolTip text="Slack" align="left-2.5">
						<motion.div
					...
					<ToolTip text="Netlify" align="left-1">
						<motion.div
					...
					<ToolTip text="Heroku" align="left-0.5">
						<motion.div
