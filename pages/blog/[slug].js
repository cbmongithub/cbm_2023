...
import { Heading, SiteHead, Socials } from "../../components";
		...
		<>
			...
			<section>
					...
					<div className="flex w-1/12 justify-start align-middle">
						<div className="relative w-7">
							<Image
								...
								height={28}
							/>
							<div className="absolute inset-0 mx-auto h-7 w-7 rounded-full bg-purple-600 opacity-25 dark:bg-gradient-to-r dark:from-purple-600 dark:to-pink-500 dark:opacity-35" />
						</div>
					</div>
				...
				<div className="flex w-full flex-row items-center justify-center ">
					...
					<TwitterShareButton
						url={shareUrl}
						title={`Check out this blog post by @cbmonx! ${data.title}`}
