            ...
            {session ? (
              ...
              >
                <div className='w-full max-w-screen-md mx-auto rounded-lg bg-white dark:bg-slate-800 shadow-xl p-5 text-slate-800'>
                  ...
                  <div className='flex flex-row justify-between items-center mt-5'>
                    ...
                    <button
                      className='px-7 py-3 mr-2 text-zinc-50 font-medium text-sm leading-snug uppercase hover:text-purple-600 focus:bg-none focus:text-purple-600 focus:outline-none focus:ring-0 active:bg-none transition duration-150 ease-in-out'
                      type='button'
                      onClick={() => signOut()}
                    >
                      Sign out
              ...
              <div className='flex flex-row justify-center items-center w-1/2 mx-auto'>
                <button
                  ...
                  type='button'
                  class='text-zinc-50 w-auto bg-gradient-to-r from-purple-600 to-pink-500 focus:ring-0 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2'
                >
                  <svg
