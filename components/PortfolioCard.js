	...
	return (
		<div className="max-w-screen overflow-hidden rounded-xl bg-white shadow-2xl dark:bg-slate-900">
			<div
				...
				alt={alt}
			>
				<div className="flex h-full w-full items-center justify-center bg-purple-600 opacity-50 dark:bg-gradient-to-r dark:from-purple-600 dark:to-pink-500" />
			</div>
			<div className="flex h-full w-full flex-col justify-center rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 opacity-60 transition duration-300 ease-in-out hover:opacity-90 hover:shadow-2xl" />
			<div className="p-6">
