const portfolioData = [
  {
    ...
    description:
      'An AI twitter bot that tweets every two hours about provided topics.',
  ...
  },
  {
    ...
    description: 'A desktop tool for real time text fill animations.',
  ...
  },
  {
    title: 'ColorfillJs',
    imgUrl:
      'https://images.unsplash.com/photo-1542831371-29b0f74f9713?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80',
    alt: 'Image for christians colorfilljs app project',
    description: 'A text fill animation library made with javascript.',
    repo: 'https://github.com/christianbmartinez/colorfilljs',
    href: 'https://www.npmjs.com/package/colorfilljs',
    tags: ['#JS', '#NPM'],
  },
  {
    title: 'MMBC',
    ...
    description:
      'A single page website for a business consulting and tax services company.',
  ...
  },
  {
    ...
    description: 'A full stack app for finding vegan only products.',
  ...
  },
  {
    ...
    description: 'A full stack app for posting anonymous content.',
