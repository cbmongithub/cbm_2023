...
const portfolioData = [
  ...
  },
  {
    ...
    description:
      'A desktop css animation configuration tool that displays real time text fill animations.',
  ...
  },
  {
    ...
    description:
      "A text fill animation library made with javascript and published to NPM's official website.",
